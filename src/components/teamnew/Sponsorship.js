              ...
              <div className="coord">
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:s.amresh@iitg.ac.in"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:athul_2001me85@iitp.ac.in"
                  />
                </div>
                <div className="icon">
              ...
              <div className="coord">
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:lucifergd192@gmail.com"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:priyanshi152002@gmail.com"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:h.bhakkad@iitg.ac.in"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="coord">
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:d.soumadip@iitg.ac.in"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:barlavani27@gmail.com"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:rajan4705kr@gmail.com"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="coord">
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:prathamkulkarni08@gmail.com"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:hardik_2001mm15@iitp.ac.in"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:s.diwan@iitg.ac.in"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="coord">
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:ashutosh_2001CS11@iitp.ac.in"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:khushi_2001cs38@iitp.ac.in"
                  />
                </div>
                <div className="icon">
                  ...
                  <Namecard
                    ...
                    link2="mailto:gaurav_2001CB22@iitp.ac.in"
                  />
                </div>
              </div>
            </div>
